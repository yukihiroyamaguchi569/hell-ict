...
このファイルは本体 4394 行を頭から読まずに済ませるための地図。**該当関数だけを Read で読む。**
...
| 1056-4394 | `<script>`（IIFE, `"use strict"`） |
