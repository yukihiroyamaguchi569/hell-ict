/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 060109c79f7a8d5ac1500904a4caddaa)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	OPENAI_BASE_URL: "https://api.openai.com/v1";
	OPENAI_MODEL: "gpt-4o";
	OPENAI_API_KEY: "";
	TEAM_ROOM: DurableObjectNamespace<import("./src/index").TeamRoom>;
	RACE_LEADERBOARD: DurableObjectNamespace<import("./src/index").RaceLeaderboard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TeamRoom" | "RaceLeaderboard";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_BASE_URL" | "OPENAI_MODEL" | "OPENAI_API_KEY">> {}
}
